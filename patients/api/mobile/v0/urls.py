...
urlpatterns = [
    ...
    # Anamnesis endpoints
    path('anamnesis/patient/<uuid:patient_id>/', views.manage_anamnesis_by_patient, name='api_mobile_anamnesis_by_patient'),
    ...
    path('doctors/<uuid:patient_id>/', views.get_patient_doctors, name='api_mobile_patient_doctors'),
]